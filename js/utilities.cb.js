...
function menu_section(variable, title, charttitle)
{
	var html = '';
...
//	html = html + '<section id="' + variable + '_section">';
	...
	html = html + '					<a  id="today_' + variable + '" class="button js-filter-' + variable + ' active sp-effect1" >';
	...
	html = html + '						</div>';
	html = html + '					</a>';
	html = html + '					<a  id="week_' + variable + '" class="button js-filter-' + variable + ' active sp-effect1" >';
	html = html + '						<div class="stacked-icons">';
	...
	html = html + '							</span><span>7</span>';
	html = html + '						</div>';
	html = html + '					</a>';
	html = html + '					<a  id="month_' + variable + '" class="button js-filter-' + variable + ' active sp-effect1" >';
	html = html + '						<div class="stacked-icons">';
	html = html + '							<span class="fa-stack fa-lg"><i class="fa fa-circle-thin fa-stack-2x fa-fw"></i>';
	...
	html = html + '						</div>';
	html = html + '					</a>';
	html = html + '					<a  id="year_' + variable + '" class="button js-filter-' + variable + ' active sp-effect1" >';
	html = html + '						<div class="stacked-icons">';
	html = html + '							<span class="fa-stack fa-lg"><i class="fa fa-circle-thin fa-stack-2x fa-fw"></i>';
