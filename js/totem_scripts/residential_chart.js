...
function Meteogram(xml, container,energyConsumptionData,energyProductionData) {
    ...
    this.energyProductionData = energyProductionData
    // Run
    this.parseYrData();
    //this.createChart();
}
...
Highcharts.setOptions({
    ...
    return {
        ...
        title: {
            text: 'Daily Energy Production and Consumption '
        },
        legend: {
            enabled: false
          },
        ...
        {
            name: 'Production',
            data: this.energyProductionData,
            step: 'left',
            marker: {
                enabled: false
            },
            ...
            {
            name: 'Consumption',
            data: this.energyConsumptionData,
            step: 'left',
            marker: {
                enabled: false
            },
...
function draw_daily_confrontation_chart(energyConsump,energyProd){ // On DOM ready...
    ...
    $.getJSON(
        ...
        function (xml) {
            var meteogram = new Meteogram(xml, 'energy_chart_confrontation',energyConsump,energyProd);
        }
    );
